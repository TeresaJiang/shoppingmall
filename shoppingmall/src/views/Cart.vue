          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascipt:;" @click="toggleCheckAll">//全选
...
<script>
  ...
  export default{
    ...
    /*filters:{//局部过滤器，日期格式化，金额格式化
      currency:currency
    },*/
    computed:{
      checkAllFlag(){//判断全选框是否选中，因为没有在后台保存checkAllFlag状态，所以实时计算
    ...
    methods:{
      ...
      delCart(){
        //console.log(this.delItem.productId);
      ...
      toggleCheckAll(){
        ...
        //因为在computed里checkAllFlag实时计算，所以不能给checkAllFlag直接取反
        this.cartList.forEach((item)=>{
